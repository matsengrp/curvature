...
Moreover, we found that rSPR graphs with 7 or more leaves have tree pairs with negative curvature, corresponding to paths that are difficult to traverse stochastically in the period before reaching stationarity.
