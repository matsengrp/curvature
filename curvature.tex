...
\begin{figure*}
	\hspace*{\stretch{1}}
	\subfigure[\label{fig:short-time-kappa-access}]{\includegraphics[width=2.3in]{figs/5t-short-time-kappa-access}}
	\hspace*{\stretch{2}}
	\subfigure[\label{fig:long-time-kappa-access}]{\includegraphics[width=2.3in]{figs/5t-long-time-kappa-access}}
	\hspace*{\stretch{1}}
    \caption{\
