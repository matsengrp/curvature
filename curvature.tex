...
\todo{CW: what is known about the uSPR graph? EM: the best bounds are in the same paper}
\cite{Ding2011-bj} showed that
$$ n - 2\ceil{\sqrt{n}} + 1
\le \Delta_{\text{TBR}}(n)
\le \Delta_{\text{SPR}}(n)
\le \floorV{\frac{\sqrt{n - 2} - 1}{2}}.
$$
...
In this paper, we investigate curvature of the rSPR graph with respect to two different random walks and connections to access times for those random walks.
