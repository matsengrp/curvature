...
The input to our algorithm is a set $\mathcal{T}$ of phylogenetic trees in the $\OhOf{n}$-length Newick \citep{felsenstein1990newick} representation of each tree as a string (assuming integer labels and bounded reasonable values of $n$, see~\citep{whidden2016efficiently}). 
