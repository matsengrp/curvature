...
\newattribute{degree}{deg}


\begin{document}
\title{Ricci-Ollivier curvature of the data-free random walks on rooted phylogenetic subtree-prune-regraft graph}
...
The work on SPR moves in the ML context has been focused on increasing efficiency of the SPR moves in finding a well-defined maximum (via simulated data) rather than investigating local maxima \cite{Hordijk2005-dl,Stamatakis2005-rh,Guindon2010-lo,Price2010-fi}.
...
\cite{Ding2011-bj} showed that the diameter of the rSPR graph is $n - \Theta(\sqrt n)$.
\todo{CW: what is known about the uSPR graph?}

Recently, a new approach to proving theorems about random walks on discrete spaces has been pioneered by Ollivier and colleagues \cite{Ollivier2009-bw,Joulin2010-jg}.
...
\begin{lemma}
	...
	\begin{enumerate}
		\item $\degree{T} = 3n^2 - 13n + 14$, if $T$ is a ladder tree\todo{notation? Song used $\lambda$-balanced},
