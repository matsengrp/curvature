...
\begin{proof}
    ...
    $N_i(T) \leq 2n - 3 - 5$ for the first set of terms, and $N_i(T) > 2n - 3 - 5$ for the second, so by replacing $N_i(T)$ in each case by $2n-3-5$ we increase the weight for $i \leq 2$ and decrease the weight on $i > 2$.
