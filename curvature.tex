...
\begin{figure*}
	...
	\caption{\
        ...
        Color signifies rSPR distance between the trees, with green, orange, blue, light blue, and brown signifying distances of 1, 2, 3, 4, and 5, respectively; the saturation of the color shows coarse curvature $\curvature{\MH; \cdot, \cdot}$, such that increased saturation (i.e.\ darker color) indicates a smaller $\kappa$.
	}
...
Furthermore, plotting the distribution of access times between pairs of trees with respect to their distance and curvature hints that smaller $\kappa$ slightly shifts the distribution of access times towards larger access times (Fig.~\ref{fig:kappa-access-distribution}, Fig.~\ref{fig:6t-short-time-kappa-access}, and Fig.~\ref{fig:7t-short-time-kappa-access}).
