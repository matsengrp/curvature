...
Lin et al.~\cite{lin2011ricci} defined a different notion of curvature in terms of lazy random walks which Loisel and Romon~\cite{Loisel2014-hu} dubbed the \emph{asymptotic} Olivier-Ricci curvature.
...
We denote the coarse curvature of the lazy random walk between two vertices $x$ and $y$ by $\curvature[p]{x,y}$.
...
Finally, we proved that the coarse and asymptotic definitions of Ollivier-Ricci curvature, coarse and asymptotic, are closely related with respect to uniform and Metropolis-Hastings walks on the rSPR graph.
