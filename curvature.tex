...
Researchers have previously identified slow mixing in MCMC with pathological data~\cite{Mossel2005-ly,Mossel2006-fo,Ronquist2006-fv}, contrasting with fast mixing identified with exceptionally well-behaved data~\cite{Stefankovic2011-hu}.
...
In particular, the simple case of sampling the uniform topology distribution without continuous parameters via (slightly modified) SPR operations is known to mix quickly~\cite{spade2014note}.
