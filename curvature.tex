...
Moreover, we proved that rSPR graph degree changes depend quadratically on the product of the size of the regrafted subtree with its change in depth as well as that rSPR treespace tends toward flatness with respect to rSPR moves that move asymptotically small subtrees.
