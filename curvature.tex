...
\documentclass[10pt,twoside,leqno,twocolumn]{article}
\usepackage{ltexpprt}
...
\author{Chris Whidden\thanks{Program in Computational Biology, Fred Hutchinson Cancer Research Center, Seattle, WA, USA 98109. \set{cwhidden,matsen}@fredhutch.org} \\
\and
...
On the other hand, fast mixing has been identified with exceptionally well-behaved data~\cite{Stefankovic2011-hu} or with a uniform distribution~\cite{spade2014note}.
...
These pairs occur infrequently in these well-connected graphs, however, they may be more problematic in real posterior distributions where the majority of probability is spread over a relatively small number of trees~\cite{Whidden2015-yi}.
...
\begin{restatable}{thm}{flatcurvature}
