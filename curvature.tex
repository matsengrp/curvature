...
\begin{figure*}
    ...
    \caption{\
        ...
        Distribution of later rSPR $\MH$ access times for those pairs of (c) 5-leaf trees with degree 24 and (d) 6-leaf trees with degree 44.
				To limit clutter, these plots exclude pairs that result from modifying pairs of trees with a smaller number of leaves by replacing a given leaf with a given subtree (e.g\ we exclude pairs of trees that both contain leaves 1 and 2 as siblings) as their access time distributions do not change substantially.
