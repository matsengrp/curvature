...
\begin{figure}
	...
	\hspace*{\stretch{1}}
	\caption{(a) The rSPR graph of $X$-trees with 4 leaves. (b) The neighborhood of an $X$-tree $T$ with 4 leaves, showing connections with $T$ and between neighbors.}
\end{figure}
...
\begin{figure*}
	\hspace*{\stretch{1}}
	\subfigure[\label{fig:short-time-kappa-access}]{\includegraphics[width=2.3in]{figs/short-time-kappa-access}}
	\hspace*{\stretch{2}}
	\subfigure[\label{fig:long-time-kappa-access}]{\includegraphics[width=2.3in]{figs/long-time-kappa-access}}
	\hspace*{\stretch{1}}
    \caption{\
