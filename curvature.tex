...
%EM You don't want to cite your latest work on uSPR?
...
%EM Do we want to interpret the degree at all? It shows a nice pattern in the plot, but I don't see any description.
...
In our next lemma, we characterize how the degree of a tree changes after an rSPR operation, showing that pairs of trees that are close in the graph can not achieve these extreme degree differences.
...
This relation allows us to improve the degree bounds between adjacent trees (Figure~\ref{fig:spr-degree-change}).
...
%EM don't we need to exclude the case of $T' = S$ and $S' = T$?
...
%EM this following sentence stands in contrast to the statement about extreme degree changes above. Or am I confused?
...
%EM If desired, could we push this statement a little bit by describing the expected size of subtrees between neighbors.
...
\end{proof}
%EM do we actually show that the bound is tight?
...
%EM Using m is a little confusing here, given how prominently m is used in the early parts of the paper for a different purpose.
