...
\begin{proof}
	...
	In particular, we assume that each subtree contributes $2n - 3 - 5$ moves.
	This underestimates the number of small moved subtrees and overestimates the number of larger moved subtrees.
	Thus, this estimate bounds the mean moved subtree size from above.
	The mean subtree size, ignoring small subtrees, is $(3 + (n-2)) / 2 = (n + 1) / 2$.
